      ...
      <Sidebar className="sidebar-wrapper" collapsed={isCollapsed}>
        <Menu iconShape="square" className="menu-wrapper">
          <MenuItem
            icon={
              <img
                src={navState.home ? icons.homeIconFilled : icons.homeIcon}
                alt="Home"
                className="menu-icon"
              />
            }
          ...
          <MenuItem
            icon={
              <img
                src={
                  navState.search ? icons.searchIconFilled : icons.searchIcon
                }
                alt="Search"
                className="menu-icon"
              />
          ...
          <MenuItem
            icon={
              <img
                src={
                  navState.explore ? icons.exploreIconFilled : icons.exploreIcon
                }
                alt="Explore"
                className="menu-icon"
              />
            ...
            onClick={() => handleMenuClick('explore', '/explore', navigate)}
          >
            탐색
          </MenuItem>
          <MenuItem
          ...
          <MenuItem
            icon={
              <img
                src={
                  navState.notification ? icons.notiIconFilled : icons.notiIcon
                }
                alt="Notifications"
                className="menu-icon"
              />
          ...
          <MenuItem
            icon={
              <img src={icons.createIcon} alt="Create" className="menu-icon" />
            }
            onClick={() => {
              handleNavClick('none');
              openModal('upload');
          ...
          <MenuItem
            ...
            onClick={() => handleMenuClick('profile', '/profile', navigate)}
          >
            프로필
          </MenuItem>
          {/* 더 보기 버튼 모달 추가하기 */}
          <MenuItem
            icon={
              <img
                src={
                  navState.more ? icons.menuMoreIconFilled : icons.menuMoreIcon
                }
                alt="더 보기"
                className="menu-icon"
              />
