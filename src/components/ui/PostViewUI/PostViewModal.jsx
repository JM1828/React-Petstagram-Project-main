          ...
          <div className="postview-content">
            <div className="postview-img-section">
              ...
              {currentPost.videoList && currentPost.videoList[0] && (
                <video controls autoPlay className="postview-video">
                  <source
                    src={`http://localhost:8088/uploads/${
                      currentPost.videoList[0].videoUrl
                    }?${new Date().getTime()}`}
                    type="video/mp4"
                  />
            ...
            <div className="postview-details-section">
              <div className="postview-header-section">
                ...
                />
                <div className="postview-username">{currentPost.email}</div>
                <img
                  src={icons.moreIcon}
                  alt="more-icon"
                ...
                <div className="postview-comments-section">
                  {postComments.map((comment) => (
                    <PostViewComment
                      ...
                      handleReplyCommentLikeClick={handleReplyCommentLikeClick}
                      showReplies={showReplies}
                      toggleReplies={toggleReplies}
                      commentLikes={commentLikes}
                      commentLiked={commentLiked}
                      replyCommentLiked={replyCommentLiked}
                      replyCommentLikes={replyCommentLikes}
                      modalType={modalType}
                    />
                  ))}
                </div>
