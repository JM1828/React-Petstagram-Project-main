...
class UserService {
  ...
  static async login(email, password) {
    const response = await axios.post(`${UserService.BASE_URL}/user/login`, {
      email,
      password,
    });
  ...
  static async getFollowings() {
    ...
    const response = await axios.get(`${UserService.BASE_URL}/user/following`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
  }
  ...
  static async getFollowers() {
    const token = localStorage.getItem('token');
    const response = await axios.get(`${UserService.BASE_URL}/user/followers`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
  }
